...
                email: user.email,
                avatarUrl: user.avatarUrl, // ✅ ADDED: Include avatarUrl in login response
            },
        });
    } catch (error) {
...
    try {
        // ✅ UPDATED: Select the avatarUrl field as well
...
// ✅ NEW: Controller to update the user's avatar
...
// ✅ UPDATED: Export the new updateAvatar function
export { registerUser, verifyOtp, loginUser, resendOtp, getAllUsers, getMessages, sendMessage, updateAvatar };